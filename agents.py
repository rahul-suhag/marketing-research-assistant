...
VERIFY_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "Rules:\n"
        "1. If every claim in the answer can be traced to the context → output "
        "   the answer unchanged, prefixed with 'PASS: '.\n"
        "2. If the answer introduces facts, statistics, definitions, or claims "
        "   NOT present in the context → output EXACTLY:\n"
        "   'FAIL'\n"
        "3. General formatting, transition words, and logical connectors are fine.\n"
        "4. Be strict: when in doubt, FAIL.\n\n"
        "Source Context:\n{context}\n\n"
        "Answer to verify:\n{answer}\n",
    ),
